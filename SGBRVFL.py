...
class SGBRVFL:
    ...
    def fit(self, X, y_tr, A_norm, idx_train, idx_test,N1, device):
        # A_norm = create_sparse_adj(A_norm, y_tr)
        ...
        EVAL_Validation = Evaluate(label.reshape(-1, 1), Validation_label)
